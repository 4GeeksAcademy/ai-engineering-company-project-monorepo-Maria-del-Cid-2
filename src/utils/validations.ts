import {Candidate, EnglishLevel, SeniorityLevel, AvailabilityStatus, CandidateStatus, VacancyStatus, Vacancy} from "../types/models";


// VALIDADIONES
//Función para validar que el candidato ha incluido toda la información necesaria y sin errores. 
